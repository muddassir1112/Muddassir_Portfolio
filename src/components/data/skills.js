export const SkillsData = [
          ...
          >
            <defs>
              ...
              >
                <stop
                  offset="0"
                  style={{ stopColor: "#4285eb", stopOpacity: "1" }}
                />
                <stop
                  offset="1"
                  style={{ stopColor: "#2ec7ff", stopOpacity: "1" }}
                />
              </linearGradient>
              <linearGradient
                id="b"
              ...
              >
                <stop
                  offset="0"
                  style={{ stopColor: "#29cdff", stopOpacity: "1" }}
                />
                <stop
                  offset=".379"
                  style={{ stopColor: "#148eff", stopOpacity: "1" }}
                />
                <stop
                  offset="1"
                  style={{ stopColor: "#0a60ff", stopOpacity: "1" }}
                />
              </linearGradient>
              <linearGradient
                id="c"
              ...
              >
                <stop
                  offset="0"
                  style={{ stopColor: "#fa816e", stopOpacity: "1" }}
                />
                <stop
                  offset=".415"
                  style={{ stopColor: "#f74a5c", stopOpacity: "1" }}
                />
                <stop
                  offset="1"
                  style={{ stopColor: "#f51d2c", stopOpacity: "1" }}
                />
              </linearGradient>
              <linearGradient
                id="d"
              ...
              >
                <stop
                  offset="0"
                  style={{ stopColor: "#fa8e7d", stopOpacity: "1" }}
                />
                <stop
                  offset=".513"
                  style={{ stopColor: "#f74a5c", stopOpacity: "1" }}
            ...
            />
            <path
              style={{ stroke: "none", fillRule: "evenodd", fill: "url(#d)" }}
  ...
  {
    type: "Version Control and Development Tools",
    list: [
      {
        name: "Git",
